...
const NOTES = 'images/20110616-1236_ElectBK1_CI_v1_6-APO.pdf#page=43';
const CANVAS_W = 600;
const CANVAS_H = 400;
...
export function generate() {
  ...
  let diagramDescription = '';
    ...
    switch(sum) {
        case 1:
            var emf, r1, r2, r3, rt, res1, res2, res3, rest, isup, i1, i2, i3, EMF, V_2, V_3, page;
            ...
            img = images['3rparallel'];
            if (img) ctx.drawImage(img, origx, origy, 531, 375);
            ...
            diagramDescription =
              'EMF ' + emf + ' V connected across 3 resistors in parallel: R1 ' + res1[0] + ' ' + res1[3] +
              ', R2 ' + res2[0] + ' ' + res2[3] + ', R3 ' + res3[0] + ' ' + res3[3] +
              '. Supply current Is is labelled.';
        ...
        case 2:
            ...
            diagramDescription =
              'EMF connected across 3 resistors in parallel: R1 ' + res1[0] + ' ' + res1[3] +
              ' with I1 ' + i1[0] + ' ' + i1[3] + ' flowing through it, R2 ' + res2[0] + ' ' + res2[3] +
              ' with I2 (value not shown), R3 (value not shown) with I3 ' + i3[0] + ' ' + i3[3] +
              ' flowing through it. Supply current Is is labelled.';
        ...
        case 3:
            ...
            diagramDescription =
              'EMF connected across 3 resistors in parallel: R1 (value not shown) with I1 ' + i1[0] + ' ' + i1[3] +
              ' flowing through it, R2 ' + res2[0] + ' ' + res2[3] + ' with I2 ' + i2[0] + ' ' + i2[3] +
              ' flowing through it, R3 ' + res3[0] + ' ' + res3[3] + ' with I3 (value not shown). Supply current Is is labelled.';
        ...
        case 4:
            ...
            diagramDescription =
              'EMF connected across 3 resistors in parallel: R1 ' + res1[0] + ' ' + res1[3] +
              ' with I1 (value not shown), R2 (value not shown) with I2 ' + i2[0] + ' ' + i2[3] +
              ' flowing through it, R3 ' + res3[0] + ' ' + res3[3] + ' with I3 ' + i3[0] + ' ' + i3[3] +
              ' flowing through it. Supply current Is is labelled.';
