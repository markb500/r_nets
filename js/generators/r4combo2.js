...
export function generate() {
  ...
  let diagramDescription = '';
    ...
    var emf, r1, r2, r3, r4, res1, res2, res3, res4, res23, res123, rest, isup, i2, i3, i4, i123, v1, v23, p3, E, page;
    suma = '<br>'.repeat(10);
    let origx = 90;
    let origy = 0;
  ...
  diagramDescription =
    'EMF ' + emf + ' V connected across R4 ' + res4[0] + ' ' + res4[3] +
    ' in parallel with a 3-resistor network: R1 ' + res1[0] + ' ' + res1[3] +
    ' in series with a 2-leg parallel network. Leg 1: R2 ' + res2[0] + ' ' + res2[3] +
    '. Leg 2: R3 ' + res3[0] + ' ' + res3[3] + '.';
