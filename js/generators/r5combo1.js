...
export function generate() {
  recentIds = QLimitRepeats(recentIds, 1);
  let sumq = '';
  let suma = '';
  let notesLink = NOTES;
  ...
  let diagramDescription = '';
    ...
    var emf, r1, r2, r3, r4, r5, res1, res2, res3, res4, res5, res34, res234, res1234, rest, isup, i2, i34, i5, i1234, v1, v234, v3, v4, p5, E, page;
    suma = '<br>'.repeat(10);
    let origx = 90;
    let origy = 0;
    ...
    sumq += "resistor to 2 decimal places in A or mA as appropriate and<BR> - the power dissipated in R<sub>5</sub>";
  ...
  diagramDescription =
    'EMF ' + emf + ' V connected across R5 ' + res5[0] + ' ' + res5[3] +
    ' in parallel with a 4-resistor network: R1 ' + res1[0] + ' ' + res1[3] +
    ' in series with a 2-leg parallel network. Leg 1: R2 ' + res2[0] + ' ' + res2[3] +
    '. Leg 2: R3 ' + res3[0] + ' ' + res3[3] + ' in series with R4 ' + res4[0] + ' ' + res4[3] + '.';
