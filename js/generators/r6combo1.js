...
export function generate() {
  ...
  let diagramDescription = '';
    ...
    var emf, r1, r2, r3, r4, r5, r6, res1, res2, res3, res4, res5, res6, res45, res3456, res23456, rest, isup, v1, page;
    ...
    } while(i3456[4] <= 0)      //Avoids negative value caused by use of rounded values in calcs
  ...
  diagramDescription =
    'EMF ' + emf + ' V connected across R1 ' + res1[0] + ' ' + res1[3] +
    ' in series with a 2-leg parallel network. Leg 1: R2 ' + res2[0] + ' ' + res2[3] +
    '. Leg 2: R3 ' + res3[0] + ' ' + res3[3] + ' in series with R6 ' + res6[0] + ' ' + res6[3] +
    ' and a 2-leg parallel network — leg 1: R4 ' + res4[0] + ' ' + res4[3] +
