...
export function generate() {
  ...
  let diagramDescription = '';
    ...
    //(r1//(r2 series with r3//r4)//r5) series with r6
    var emf, r1, r2, r3, r4, r5, r6, res1, res2, res3, res4, res5, res6, res34, res234, res12345, rest, isup, v6, page;
    ...
    } while(v12345[4] <= 0)      //Avoids negative value caused by use of rounded values in calcs
  ...
  diagramDescription =
    'EMF ' + emf + ' V connected across R6 ' + res6[0] + ' ' + res6[3] +
    ' in series with a 3-leg parallel network. Leg 1: R1 ' + res1[0] + ' ' + res1[3] +
    '. Leg 2: R5 ' + res5[0] + ' ' + res5[3] +
    '. Leg 3: R2 ' + res2[0] + ' ' + res2[3] + ' in series with a 2-leg parallel network — leg 1: R3 ' +
    res3[0] + ' ' + res3[3] + '; leg 2: R4 ' + res4[0] + ' ' + res4[3] + '.';
