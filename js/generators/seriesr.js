...
const NOTES = 'images/20110616-1236_ElectBK1_CI_v1_6-APO.pdf#page=32';
const CANVAS_W = 500;
const CANVAS_H = 400;
...
export function generate() {
  ...
  let diagramDescription = '';
    ...
    let origx = 100;
    let origy = 40;
    recentIds = QLimitRepeats(recentIds, 4);   //Ensures no repeat question until at least 50% of questions shown
    const sum = recentIds[recentIds.length - 1];
    switch(sum) {
        case 1:
            var emf, r1, r2, r3, res1, res2, res3, rest, v1, v2, v3, isup, I_2, I_3, I_S, R_1, R_2, R_3, page;
            ...
            img = images['3rseries'];
            if (img) ctx.drawImage(img, origx + 20, origy, 281, 355);
            ...
            diagramDescription =
              'EMF ' + emf + ' V connected to 3 resistors in series: R1 ' + res1[0] + ' ' + res1[3] +
              ', R2 ' + res2[0] + ' ' + res2[3] + ', R3 ' + res3[0] + ' ' + res3[3] + '. Supply current Is is labelled.';
        ...
        case 2:
            ...
            diagramDescription =
              'EMF connected to 3 resistors in series: R1 ' + res1[0] + ' ' + res1[3] +
              ' with V1 across it (value not shown), R2 (value not shown) with V2 ' + v2[0] + ' ' + v2[3] +
              ' across it, R3 ' + res3[0] + ' ' + res3[3] + ' with V3 ' + v3[0] + ' ' + v3[3] +
              ' across it. Supply current Is is labelled.';
            ...
            suma += "&=\\underline{\\mathbf{" + dp(v1[0] + v2[0] + v3[0], 2, -1) + " " + v1[3] + "}}\\\\[5pt]";
            suma += "\\end{aligned}$$";
            break;
        case 3:
            ...
            diagramDescription =
              'EMF connected to 3 resistors in series: R1 (value not shown) with V1 ' + v1[0] + ' ' + v1[3] +
              ' across it, R2 ' + res2[0] + ' ' + res2[3] + ' with V2 ' + v2[0] + ' ' + v2[3] +
              ' across it, R3 ' + res3[0] + ' ' + res3[3] + ' with V3 across it (value not shown). Supply current Is is labelled.';
        ...
        case 4:
            ...
            diagramDescription =
              'EMF connected to 3 resistors in series: R1 ' + res1[0] + ' ' + res1[3] +
              ' with V1 ' + v1[0] + ' ' + v1[3] + ' across it, R2 ' + res2[0] + ' ' + res2[3] +
              ' with V2 across it (value not shown), R3 (value not shown) with V3 ' + v3[0] + ' ' + v3[3] +
              ' across it. Supply current Is is labelled.';
  ...
  // Always attach canvas (diagrams are central to these questions)
  out.canvas = {
    width: CANVAS_W,
    height: CANVAS_H,
    withSolution: false,
    description: diagramDescription || 'Resistor network circuit diagram for this question.',
    draw: (c) => {
      img = new Image();
